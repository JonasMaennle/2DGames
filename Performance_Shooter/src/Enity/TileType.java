...
public enum TileType {
	...
	RedWood_01("redwood_01", 0, 448, 640),RedWood_02("redwood_02", 0, 448, 640),RedWood_03("redwood_03", 0, 448, 640),
	RedWood_04("redwood_04", 0, 384, 640),RedWood_05("redwood_05", 0, 384, 512),RedWood_06("redwood_06", 0, 384, 512),
	RedWood_07("redwood_01", 0, 348, 512),RedWood_08("redwood_08", 0, 256, 384),RedWood_09("redwood_01", 0, 512, 768),
	
	TreeStump_Left("tree_stump_left", 100, TILE_SIZE, TILE_SIZE),TreeStump_Right("tree_stump_right", 100, TILE_SIZE, TILE_SIZE),TreeStump_Center("tree_stump_center", 100, TILE_SIZE, TILE_SIZE),
