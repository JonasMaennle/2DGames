...
public enum TileType {
	...
	Grass_Round_Half("Grass_Round_Half", 100, TILE_SIZE, TILE_SIZE, 6566450),
	Grass_Left_Half("Grass_Left_Half", 100, TILE_SIZE, TILE_SIZE, 9843250),
	Grass_Right_Half("Grass_Right_Half", 100, TILE_SIZE, TILE_SIZE, 9843270),
	Grass_Flat_Half("Grass_Flat_Half", 100, TILE_SIZE, TILE_SIZE, 9848390),
