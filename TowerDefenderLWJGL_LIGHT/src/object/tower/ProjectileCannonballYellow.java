...
public class ProjectileCannonballYellow extends Projectile{
	private float x, y;
	private int width, height;
	
	public ProjectileCannonballYellow(ProjectileType type, Enemy target, float x, float y, int width, int height, Light light) 
	{
