...
public class Weapon_Flamethrower extends Weapon_Basic{
	...
	private void addFireParticle(){
		...
		if(player.getDirection().equals("right")){
			...
			particleList.add(new Particle((int)centX + 12, (int)(centY - (angleOffset * 100)), rand.nextInt(4) + 4, rand.nextInt(4) + 4, velX + player.getVelX(), velY, rand.nextInt(4)+4, "orange", rand.nextInt(100)));
		}else{
			angleOffset = 0;
			...
			particleList.add(new Particle((int)centX - 12, (int)(centY - (angleOffset * 100)), rand.nextInt(4) + 4, rand.nextInt(4) + 4, velX + player.getVelX(), velY, rand.nextInt(5)+4, "orange", rand.nextInt( 100)));
		}
