...
public class Weapon_LaserShotgun extends Weapon_Basic {
	...
	public void shoot() {
		...
		if (player.getDirection().equals("right")) {
			...
			bulletList.add(new Bullet_Laser(centX + 4, centY - (angleOffset * 100), 20, 6, destX, destY - 40, "right", bulletSpeed, angle, new Color(20, 0, 0)));
			bulletList.add(new Bullet_Laser(centX + 4, centY - (angleOffset * 100), 20, 6, destX, destY - 20 , "right", bulletSpeed, angle, new Color(20, 0, 0)));
			bulletList.add(new Bullet_Laser(centX + 4, centY - (angleOffset * 100), 20, 6, destX, destY, "right", bulletSpeed, angle, new Color(20, 0, 0))); // center
			bulletList.add(new Bullet_Laser(centX + 4, centY - (angleOffset * 100), 20, 6, destX, destY + 20, "right", bulletSpeed, angle, new Color(20, 0, 0)));
			bulletList.add(new Bullet_Laser(centX + 4, centY - (angleOffset * 100), 20, 6, destX, destY + 40, "right", bulletSpeed, angle, new Color(20, 0, 0)));
		}
		...
		if (player.getDirection().equals("left")) {
			...
			bulletList.add(new Bullet_Laser(centX - 4, centY - (angleOffset * 100), 20, 6, destX, destY - 40, "left", bulletSpeed, angle, new Color(20, 0, 0)));
			bulletList.add(new Bullet_Laser(centX - 4, centY - (angleOffset * 100), 20, 6, destX, destY - 20, "left", bulletSpeed, angle, new Color(20, 0, 0)));
			bulletList.add(new Bullet_Laser(centX - 4, centY - (angleOffset * 100), 20, 6, destX, destY, "left", bulletSpeed, angle, new Color(20, 0, 0))); // center
			bulletList.add(new Bullet_Laser(centX - 4, centY - (angleOffset * 100), 20, 6, destX, destY + 20, "left", bulletSpeed, angle, new Color(20, 0, 0)));
			bulletList.add(new Bullet_Laser(centX - 4, centY - (angleOffset * 100), 20, 6, destX, destY + 40, "left", bulletSpeed, angle, new Color(20, 0, 0)));
		}
